            ...
            <div className="card p-0 overflow-hidden border border-surface-700/50 shadow-xl shadow-black/20 bg-surface-800/40 backdrop-blur-sm">
                <div className="p-6 border-b border-surface-700/50 bg-surface-800/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-bold text-lg text-surface-100">OCR Modell-Vergleich</h3>
                    ...
                    <div>
                        ...
                        {loadingModels ? (
                            ...
                            <div>
                                ...
                                {showModelPicker && (
                                    <div className="mt-2 p-2 rounded-xl bg-white/85 backdrop-blur-xl border border-white max-h-64 overflow-y-auto custom-scrollbar animate-in fade-in slide-in-from-top-2 duration-200 shadow-xl">
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={clsx(
                                                        ...
                                                        isSelected
                                                            ? 'bg-violet-500/15 text-violet-800 border border-violet-500/30'
                                                ...
                                                >
                                                    ...
                                                    {isCurrent && (
                                                        <span className="ml-auto text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-500/15 text-emerald-800 border border-emerald-500/30 flex-shrink-0">
                                                            aktiv
                                                        </span>
                                                    )}
                                                </button>
                                ...
                                {selectedModels.length > 0 && (
                                    <div className="flex flex-wrap gap-2 mt-3">
                                        {selectedModels.map((model, i) => (
                                            <span
                                                key={model}
                                                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-violet-500/15 text-violet-800 text-xs font-mono border border-violet-500/30"
                                            >
                                                <span className="w-4 h-4 rounded-full bg-violet-500/20 text-[10px] font-bold flex items-center justify-center text-violet-800">
                                                    {i + 1}
                                                </span>
                                                {model}
                                                {!running && (
                    ...
                    <div className="card p-4 border border-surface-700/50 bg-surface-800/40">
                        <div className="flex flex-wrap items-center gap-4 text-sm">
                            <div className="flex items-center gap-2 text-surface-300">
                                ...
                                <span className="font-medium text-surface-100">{result.title}</span>
                        ...
                        <div className="card p-0 overflow-hidden border border-orange-500/30 bg-surface-800/40">
                            {!showEvalWarning ? (
                                ...
                                >
                                    ...
                                    <div>
                                        <p className="font-bold text-surface-100 text-sm">KI-Qualitätsbewertung (Cloud API)</p>
                                        <p className="text-xs text-surface-400">
                                    ...
                                    <div className="flex items-start gap-3 p-4 rounded-xl bg-orange-500/10 border border-orange-500/30">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-xs text-orange-200/80 leading-relaxed">
                                                Die OCR-Texte werden an OpenAI gesendet. Der Dokumenteninhalt verlässt
                    ...
                    {evaluating && (
                        <div className="card p-6 border border-orange-500/30 bg-surface-800/40 animate-in fade-in duration-200">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-bold text-surface-100 text-sm">KI analysiert OCR-Ergebnisse...</p>
                                    <p className="text-xs text-surface-400">
                            ...
                            <div className="card p-0 overflow-hidden border border-orange-500/30 bg-surface-800/40">
                                <div className="p-4 border-b border-surface-700/50 bg-orange-500/5">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            <Sparkles className="w-5 h-5 text-orange-400" />
                                            <span className="font-bold text-surface-100 text-sm">KI-Qualitätsbewertung</span>
                                        </div>
                                        ...
                                        <div className="p-4 border-b border-surface-700/50 bg-surface-800/50">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="font-mono font-bold text-surface-100">{entry.model}</span>
