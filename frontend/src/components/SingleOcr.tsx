...
export default function SingleOcr({ initialDocId }: SingleOcrProps = {}) {
    ...
    return (
        <div className="space-y-8 pb-12">
            {/* Header */}
            <div>
                <h2 className="font-display text-3xl font-bold text-surface-100 flex items-center gap-3">
            ...
            <div className="card p-0 overflow-hidden border border-surface-700/50 shadow-xl shadow-black/20 bg-surface-800/40 backdrop-blur-sm">
                <div className="p-6 border-b border-surface-700/50 bg-surface-800/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-bold text-lg text-surface-100">Dokument-ID</h3>
                                ...
                                {(progress.pages || []).map((pg) => (
                                    <div
                                        ...
                                        className={clsx(
                                            ...
                                            pg.status === 'done' && 'bg-emerald-500/20 border-emerald-500/40 text-emerald-800',
                                            pg.status === 'processing' && 'bg-cyan-500/20 border-cyan-500/40 text-cyan-800 animate-pulse',
                                            pg.status === 'error' && 'bg-red-500/20 border-red-500/40 text-red-800',
                ...
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="card p-0 overflow-hidden border border-surface-700/50 bg-surface-800/40">
                        <div className="p-6 border-b border-surface-700/50 bg-surface-800/50">
                            <div className="flex items-center justify-between flex-wrap gap-4">
                                <div>
                                    <h3 className="text-xl font-bold text-surface-100">{result.title}</h3>
                                ...
                                <div className={clsx(
                                    ...
                                    qualityWarning
                                        ...
                                        : 'bg-emerald-500/15 text-emerald-900 border border-emerald-500/40'
                                )}>
                        ...
                        {/* Quality Warning */}
                        {qualityWarning && (
                            <div className="mx-6 mt-4 p-4 rounded-xl bg-amber-500/10 border border-amber-500/40 flex items-start gap-3">
                    ...
                    {!applied ? (
                        ...
                        <div className="p-5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-bold text-emerald-900">Text wird gespeichert!</p>
                                <p className="text-sm text-emerald-800 mt-0.5">Paperless-ngx aktualisiert den Suchindex im Hintergrund. Das kann einige Sekunden dauern.</p>
                            </div>
                        </div>
                    )}
                </div>
