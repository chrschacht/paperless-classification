...
export default function OcrManager() {
    ...
    const startBatch = async () => {
        ...
        setBatchStatus(null)
        try {
            await api.startBatchOcr('tagged', undefined, setFinishTag, true)
            setBatchRunning(true)
            startPolling()
        } catch (e) {
    ...
    const badgeColorMap: Record<string, string> = {
        ...
        red: 'bg-red-500/20 text-red-800',
            ...
            <div>
                <div className="flex justify-between items-start">
                    ...
                    {watchdogStatus?.enabled && (
                        <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/60 border border-purple-500/30 text-xs font-medium text-purple-700 shadow-lg shadow-purple-900/10 animate-in fade-in">
                    ...
                    <div className="card p-0 overflow-hidden border border-surface-700/50 shadow-xl shadow-black/20 bg-surface-800/40 backdrop-blur-sm">
                        <div className="p-6 border-b border-surface-700/50 bg-surface-800/50">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="font-bold text-lg text-surface-100">Batch Processing</h3>
                        ...
                        <div className="p-6 space-y-6">
                            {/* Fixed Paperless Classification policy */}
                            <div className="p-4 rounded-xl border border-primary-500/30 bg-primary-500/10 flex items-start gap-3">
                                <span className="text-xl">🏷️</span>
                                <div>
                                    <p className="font-medium text-sm text-surface-100">Nur Tag-basierte OCR</p>
                                    <p className="text-xs text-surface-400 mt-1">
                                        Verarbeitet ausschließlich Dokumente mit dem Tag <code className="text-primary-400">runocr</code>.
                                        Eine Auswahl über Datenbankstatus oder alle Dokumente ist deaktiviert.
                                    </p>
                                </div>
                            </div>
        ...
        <div className="space-y-6">
            ...
            {loading ? (
                ...
                <div className="card p-12 text-center border border-surface-700/50 bg-surface-800/40">
                    ...
                    <p className="text-xl font-bold text-surface-100">Keine Fehler 🎉</p>
        ...
        <div className="space-y-6">
            ...
            {loading ? (
                ...
                <div className="card p-12 text-center border border-surface-700/50 bg-surface-800/40">
                    ...
                    <p className="text-xl font-bold text-surface-100">Keine ignorierten Dokumente</p>
