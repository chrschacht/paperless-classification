            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="font-display text-3xl font-bold text-white flex items-center gap-3">
                        ...
                        {items.length > 0 && (
                            <span className="ml-2 px-3 py-1 text-sm bg-amber-500/15 text-amber-900 rounded-full border border-amber-500/40">
                                {items.length}
                            </span>
                        )}
                    </h2>
                ...
                <div className="flex items-center gap-2">
                    {items.length > 0 && (<>
                        <button
                            ...
                            className="btn bg-emerald-600/15 hover:bg-emerald-600/25 text-emerald-900 border border-emerald-500/40 flex items-center gap-2 disabled:opacity-50"
                        ...
                        <button
                            ...
                            className="btn bg-amber-600/15 hover:bg-amber-600/25 text-amber-900 border border-amber-500/40 flex items-center gap-2 disabled:opacity-50"
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4">
                            {item.suggest_keep_original && (
                                <div className="px-3 py-1.5 rounded-lg text-xs font-bold bg-orange-500/15 text-orange-900 border border-orange-500/40 flex items-center gap-1.5">
                            ...
                            <div className={clsx(
                                ...
                                item.ratio < 25
                                    ? 'bg-red-500/15 text-red-900 border border-red-500/40'
                                    : item.ratio < 40
                                        ? 'bg-orange-500/15 text-orange-900 border border-orange-500/40'
                        ...
                        <div className="p-6 border-t border-surface-700/50 bg-surface-900/30 animate-in slide-in-from-top-2 duration-300">
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="bg-cyan-50/70 rounded-xl p-4 border border-cyan-500/30 max-h-[500px] overflow-y-auto custom-scrollbar">
                                        <pre className="text-sm text-cyan-950 whitespace-pre-wrap font-mono leading-relaxed">
            ...
            {!hideSubLists && errorList.length > 0 && (
                <div className="mt-8">
                    ...
                    >
                        ...
                        <span className="px-2 py-0.5 text-xs bg-red-500/15 text-red-900 rounded-full border border-red-500/40">
                            {errorList.length}
                        </span>
                    ...
                    {showErrorList && (
                        <div className="space-y-2 animate-in slide-in-from-top-2 duration-200">
                            <p className="text-sm text-surface-500 mb-3">
                                Diese Dokumente sind nach 3+ Fehlversuchen dauerhaft als fehlerhaft markiert (Tag: <code className="text-red-800">ocrfehler</code>).
                                ...
                                >
                                    <div className="flex items-center gap-3 flex-1 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-xs text-red-800 mt-1 truncate" title={entry.error}>
                                                {entry.error}
                                            </p>
                                        </div>
                                    </div>
